...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder->getRootNode()
            ->children()
                ->scalarNode('repository_namespace')->defaultValue('Domain\Repository')->end()
                ->scalarNode('entity_namespace')->defaultValue('Domain\Model')->end()
                ...
                ->arrayNode('pagination')
                    ->children()
                        ->scalarNode('page')->defaultValue('1')->end()
                        ->scalarNode('rows_per_page')->defaultValue('10')->end()
                    ->end()
                ->end()
            ->end()
        ;
